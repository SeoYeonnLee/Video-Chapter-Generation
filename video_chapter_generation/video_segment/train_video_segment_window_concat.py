...
from model.fusion import two_stream_window_concat
...
class Trainer:
    def __init__(self, model, train_dataset, test_dataset, config):
        ...
        base_lrs = [1e-5, 1e-5, 3e-5, 2e-5, 1e-5] # BERT, ResNet, Fusion, Window, Classifier
...
if __name__ == "__main__":
    ...
    ckpt_path = f"/home/work/capstone/Video-Chapter-Generation/video_chapter_generation/checkpoint/chapter_localization/window_concat_frame_{args.clip_frame_num}_40/checkpoint.pth"
    ...
    test_clips_json = "/home/work/capstone/Video-Chapter-Generation/video_chapter_youtube_dataset/dataset/validation_clips_clip_frame_num_16_50p.json"
    ...
    try:
        ...
        if args.data_mode == "all":
            ...
            model = two_stream_window_concat.TwoStream(
