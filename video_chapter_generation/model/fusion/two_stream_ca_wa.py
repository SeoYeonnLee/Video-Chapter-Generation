'''
clip embedding cross attention + window attention
'''
import gc
import math
import torch
...
class CrossAttention(nn.Module):
    ...
    def _init_weights(self):
        ...
        for module in [self.frame_pos_encoding]:
            for layer in module:
    ...
    def forward(self, lang_out, vision_out, clip_info):
        ...
        for i in range(batch_size):
            local_pos = self.get_frame_positions(
        ...
        vision_out = vision_out + local_pos_emb
        ...
        ffn_output = self.ffn(fusion_emb)  # [batch, 1, hidden_size]
        ...
        if not self.training:
            ...
            # ]
            intermediate_tensors = [
                local_positions, local_pos_emb,
                query, key, value, attn_scores, attn_probs,
                attn_output, vision_pooled, ffn_output
            ]
